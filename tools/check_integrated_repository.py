...
REQUIRED = [
    ...
    "figures/final_submission/설계회로 구현결과/GPDK045 AXI 표준셀 배치 결과.gif",
    "figures/final_submission/설계회로 구현결과/GPDK045 AXI 최종 배치배선 결과.gif",
    "figures/final_submission/설계회로 구현결과/GPDK045 AXI Clock Net 선택 결과.gif",
    "figures/final_submission/설계회로 구현결과/GPDK045 AXI QRS-MAF 배치 선택 결과.gif",
