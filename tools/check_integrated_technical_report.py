...
REQUIRED_TEXT = [
    ...
    "44,602", "131,487.003 µm²", "setup +2.602 ns", "hold +0.010 ns",
    "3.71636663 mW", "933,258.465 µm", "331,718",
...
REQUIRED_VERBATIM_EXCERPTS = [
    ...
    "Run-6 AXI는 50% floorplan에서 setup·hold·data-transition·clock-slew·internal-DRC를 모두 닫고, 100 ps uncertainty 뒤에 추가 hold slack 10 ps와 clean LEC를 유지했다.",
