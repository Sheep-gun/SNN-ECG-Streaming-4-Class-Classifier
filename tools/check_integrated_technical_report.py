...
REQUIRED_VERBATIM_EXCERPTS = [
    ...
    "장시간 처리와 저전력 목표도 각각 30분 입력 검증, 이상적 power-gating 산출, vectorless ASIC 추정과 제한된 core conditioned activity window에 근거하므로 조건부로 유지한다.",
    "Forced gate 결과와 timing check를 끈 single-seed MAX-SDF pilot은 유한 seed의 조건부 초기화 민감도이지 unmodified GLS·power-up·SDF timing regression·signoff 근거가 아니다.",
]
FORBIDDEN = [
