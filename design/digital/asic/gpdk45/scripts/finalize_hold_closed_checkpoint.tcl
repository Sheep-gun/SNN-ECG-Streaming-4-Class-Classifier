foreach required_env {RUN_ROOT INPUT_CHECKPOINT ASIC_PROFILE FINAL_TAG} {
...
set report_dir [file join $run_root reports final_checkpoint $profile $tag]
set output_dir [file join $run_root outputs final_checkpoint $profile $tag]
...
puts $config "final_tag=$tag"
puts $config "analysis=MMMC_OCV_CPPR_SI_IQuantus_high"
puts $config "power=vectorless_default_input_and_sequential_activity_0.10"
close $config
exit
